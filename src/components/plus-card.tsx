...
export function PlusCard({ href, card }: { href: string; card: React.JSX.Element }) {
  return (
    <Link href={href}>
      <motion.div
        whileHover={{ y: -10 }}
        className="border border-black/[0.2] dark:border-white/[0.2] dark:text-white text-black flex items-start aspect-auto w-xs sm:w-sm md:w-lg lg:w-4xl lg:h-92 mx-auto relative cursor-pointer"
      >
